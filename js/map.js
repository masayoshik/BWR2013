...
//  var latlng = new google.maps.LatLng(48.589326,-2.09385);
  var latlng = new google.maps.LatLng(63.04,-147.6);
  var opts = {
    zoom: 7,
    center: latlng,
...
//  content_ = content_.replace("LOC",location);
  var content_ = "Masa's Location at</br>ATIME (Alaska Time)</br>CTIME (California)</br>JTIME (Japan)";
  content_ = content_.replace("ATIME",atime);
  ...
  var routeLayer = new google.maps.KmlLayer('http://masaridespbp.com/BWR2013/BWR_r.kml');
  routeLayer.setMap(map);
}

function doOpen () {
  map.panTo(63.04,-147.6);
}
